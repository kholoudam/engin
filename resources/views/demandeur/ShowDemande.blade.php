                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="shadow-primary border-radius-lg pt-4 pb-3" style="background-color:#e10505;">
                                    <h6 class="text-white text-capitalize ps-3">détail de la demande</h6>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card" style="width: 30rem; margin-left: 18rem; background-color: #d8d8d8;">
                                                <div class="card-body">
                                                    <h5 class="card-title text-center"><em>ID de la demande :</em>{{ $demande->id }}</h5>
                                                    <p class="card-text">
                                                        <strong>Entité: </strong>{{ $demande->Entite }}
                                                        <br>
                                                        <strong>Poste: </strong>{{ $demande->Poste }}
                                                        <br>
                                                        <!-- <strong>Date de sortie: </strong>{{ $demande->DateSortie }} -->
                                                        <!-- <br> -->
                                                        <strong>Shift: </strong>{{ $demande->Shift }}
                                                        <br>
                                                        @foreach($demande->detailDemandes as $detail)
                                                            <strong>Famille de l'engin: </strong>{{ $detail->FamilleEngin }}
                                                            <br>
                                                            <strong>Type de l'engin: </strong>{{ $detail->TypeEngin }}
                                                            <br>
                                                            <strong>Quantité: </strong>{{ $detail->Quantite }}
                                                            <br>
                                                            <strong>Raison de la demande: </strong>{{ $detail->RaisonDemande }}
                                                        @endforeach
                                                    </p>
                                                </div>
                                            </div>
