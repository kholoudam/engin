                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="shadow-primary border-radius-lg pt-4 pb-3" style="background-color:#e10505;">
                                    <h6 class="text-white text-capitalize ps-3">Ajouter demande</h6>
                                </div>
                            </div>
                                ...
                                <form action="{{ route('demandes.store') }}" method="POST">
                                    ...
                                    <div class="row justify-content-between text-left">
                                        <div class="form-group col-sm-6 flex-column d-flex">
                                            <label class="form-control-label px-3">Entité<span class="text-danger"> *</span></label>
                                            <input type="text" id="Entite" name="Entite" placeholder="">
                                        </div>
                                        <div class="form-group col-sm-6 flex-column d-flex">
                                            <label class="form-control-label px-3">Poste<span class="text-danger"> *</span></label> 
                                            <input type="text" id="Poste" name="Poste" placeholder="">
                                        </div>
                                    </div>
                                    <div class="row justify-content-between text-left">
                                        <div class="form-group col-sm-6 flex-column d-flex">
                                            <label class="form-control-label px-3">Shift<span class="text-danger"> *</span></label> 
                                            <input type="text" id="Shift" name="Shift" placeholder="">
                                        </div>
                                        <div class="form-group col-sm-6 flex-column d-flex">
                                            <label class="form-control-label px-3">Famille engin<span class="text-danger"> *</span></label>
                                            <select id="FamilleEngin" name="FamilleEngin">
                                    ...
                                    <div class="row justify-content-between text-left">
                                        <div class="form-group col-sm-6 flex-column d-flex">
                                            <label class="form-control-label px-3">Type engin<span class="text-danger"> *</span></label> 
                                            <input type="text" id="TypeEngin" name="TypeEngin" placeholder="">
                                        </div>
                                        <div class="form-group col-sm-6 flex-column d-flex">
                                            <label class="form-control-label px-3">Quantité<span class="text-danger"> *</span></label>
                                            <input type="number" id="Quantite" name="Quantite" placeholder="">
                                        </div>
                                    </div>
                                    <div class="row justify-content-between text-left">
                                        <div class="form-group col-sm-6 flex-column d-flex">
                                            <label class="form-control-label px-3">Raison de la demande<span class="text-danger"> *</span></label> 
                                            <input type="text" id="RaisonDemande" name="RaisonDemande" placeholder="">
                                        </div>
                                    </div>
                                    <center>
                                        <button type="submit" class="btn btn-primary btn-block mb-4 mt-3" style="background-color:#e10505;">Confirmer</button>
                                    </center>
                                </form>
                            </div>
                        </div>
