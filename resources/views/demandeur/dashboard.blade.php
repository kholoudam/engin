    ...
    <body class="g-sidenav-show  bg-gray-200">
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gray-600" id="sidenav-main">
            ...
            <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link text-white active"  style="background-color:#e10505;" href="{{ route('demandeur.index') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="{{ route('engins.index') }}">
                            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="container-fluid py-4">
                <div class="row">
                    <div class="col-lg-4 col-md-6 mb-4">
                        <a href="{{ route('demandes.create') }}" class="text-decoration-none">
                            <div class="card card-frame" style="background-color: #4caf50;">
                                <div class="card-body d-flex align-items-center justify-content-center" style="padding: 2px;">
                                    <i class="material-icons me-4" style="color: white; font-size: 44px;">add</i>
                                    <h6 class="mb-0" style="color: white; font-size: 24px; font-weight: 200; font-style: italic;">Ajouter demande</h6>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <a href="{{ route('demandes.index') }}" class="text-decoration-none">
                            <div class="card card-frame bg-white">
                                <div class="card-body d-flex align-items-center justify-content-center" style="padding: 2px;">
                                    <i class="material-icons me-4" style="color: black; font-size: 44px;">view_list</i>
                                    <h6 class="mb-0" style="color: black; font-size: 24px; font-weight: 200; font-style: italic;">Liste demande</h6>
                                </div>
                            </div>
                        </a>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <a href="{{ route('engins.index') }}" class="text-decoration-none">
                            <div class="card card-frame bg-white">
                                <div class="card-body d-flex align-items-center justify-content-center" style="padding: 2px;">
                                    <i class="material-icons me-4" style="color: black; font-size: 44px;">directions_car</i>
                                    <h6 class="mb-0" style="color: black; font-size: 24px; font-weight: 200; font-style: italic;">Liste des engins</h6>
                                </div>
                            </div>
                        </a>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-header p-3 pt-2">
                                ...
                                <div class="text-end pt-1">
                                    ...
                                    <p class="text-sm mb-0 font-weight-bold ms-1">Les demandes les plus récentes</p>
                                </div>
                            </div>
                                    ...
                                    <table class="table align-items-center mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Exit Date</th>
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Shift</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach ($latest as $demande)
                                                <tr>
                                                    <td class="text-center">{{ $demande->Entite }}</td>
                                                    <td class="text-center">{{ $demande->Poste }}</td>
                                                    <td class="text-center">{{ $demande->DateSortie ? \Carbon\Carbon::parse($demande->DateSortie)->format('d M Y') : 'Not Set' }}</td>
                                                    <td class="text-center">{{ $demande->Shift }}</td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                    </table>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card h-50">
                            <div class="card-header p-3 pt-2">
                                ...
                                <div class="text-end pt-1">
                                    <p class="text-sm mb-0 text-capitalize">Nombre total de demande</p>
                                </div>
                            </div>
                            <hr class="dark horizontal my-0">
                            <div class="card-footer p-3">
                                <p class="mb-0"><span class="text-success text-sm font-weight-bolder" id="sum-demandes"></span> demandes</p>
                            </div>
                        </div>
                    </div>
                </div>
                <script>
                    fetch('/api/demandes/sum')
                        .then(response => response.json())
                        .then(data => {
                            document.getElementById('sum-demandes').textContent = data.sum;
                        });
                </script>
