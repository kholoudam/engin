    ...
    <body class="g-sidenav-show  bg-gray-200">
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gray-600" id="sidenav-main">
            ...
            <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link text-white active"  style="background-color:#e10505;" href="{{ route('admin.index') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="{{ route('GestionEngins.index') }}">
                            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="container-fluid py-4">
                <div class="row">
                    <div class="col-lg-4 col-md-6 mb-4">
                        <a href="{{ route('GestionEngins.create') }}" class="text-decoration-none">
                            <div class="card card-frame" style="background-color: #4caf50;">
                                <div class="card-body d-flex align-items-center justify-content-center" style="padding: 2px;">
                                    ...
                                    <h6 class="mb-0" style="color: white; font-size: 24px; font-weight: 200; font-style: italic;">Ajouter engin</h6>
                                </div>
                            </div>
                        </a>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-4">
                        <a href="{{ route('GestionEngins.index') }}" class="text-decoration-none">
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <a href="{{ route('Utilisateurs.index') }}" class="text-decoration-none">
                            <div class="card card-frame bg-white">
                                <div class="card-body d-flex align-items-center justify-content-center" style="padding: 2px;">
                                    <i class="material-icons me-4" style="color: black; font-size: 44px;">person</i>
                                    <h6 class="mb-0" style="color: black; font-size: 24px; font-weight: 200; font-style: italic;">Liste des utilisateurs</h6>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <div class="row" style="margin-left: 100px;">
                    <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4" style="width: 400px;">
                        <div class="card">
                            <div class="card-header p-3 pt-2">
                                ...
                                <div class="text-end pt-1">
                                    ...
                                    <h4 class="mb-0" id="sum-utilisateurs">Loading...</h4>
                                </div>
                            </div>
                    ...
                    <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4" style="width: 400px;">
                        <div class="card">
                            <div class="card-header p-3 pt-2">
                                ...
                                <div class="text-end pt-1">
                                    <p class="text-sm mb-0 text-capitalize">Total Engins</p>
                                    <h4 class="mb-0" id="sum-engins">Loading...</h4>
                                </div>
                            </div>
                            <hr class="dark horizontal my-0">
                            <div class="card-footer p-3">
                                <p class="mb-0">Nombre total d'engins</p>
                            </div>
                        </div>
                    </div>
                </div>
                <script>
                    document.addEventListener('DOMContentLoaded', function () {
                        ...
                        fetch('/api/sum-utilisateurs')
                            .then(response => response.json())
                            .then(data => {
                                document.getElementById('sum-utilisateurs').innerText = data.sum;
                            });
                        // Récupérer le total des engins
                        fetch('/api/sum-engins')
                            .then(response => response.json())
                            .then(data => {
                                document.getElementById('sum-engins').innerText = data.sum;
                            });
                    });
                </script>
