                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card" style="width: 30rem; margin-left: 18rem; background-color: #d8d8d8;">
                                                <div class="card-body">
                                                    <h5 class="card-title text-center"><em>ID de l'utilisateur :</em>{{ $utilisateurs->id }}</h5>
                                                    <p class="card-text">
                                                        <strong>Nom: </strong>{{ $utilisateurs->nom }}
                                                        <br>
                                                        <strong>Prénom: </strong>{{ $utilisateurs->prenom }}
                                                        <br>
                                                        <strong>Username: </strong>{{ $utilisateurs->username }}
                                                        <br>
                                                        <strong>Rôle: </strong>{{ $utilisateurs->role }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
