                ...
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Ajouter un utilisateur</li>
                        </ol>
                        <h6 class="font-weight-bolder mb-0">Ajouter un utilisateur</h6>
                    </nav>
                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="shadow-primary border-radius-lg pt-4 pb-3" style="background-color:#e10505;">
                                    <h6 class="text-white text-capitalize ps-3">Modifier un utilisateurs</h6>
                                </div>
                            </div>
                            <div class="card-body px-4 pb-2">
                                <form action="{{ route('Utilisateurs.update', $utilisateur->id) }}" method="POST">
                                    ...
                                    <div class="row justify-content-between text-left">
                                        ...
                                        <div class="form-group col-sm-6 flex-column d-flex">
                                            <label class="form-control-label px-3">Prénom</label> 
                                    ...
                                    <div class="row justify-content-between text-left">
                                        <div class="form-group col-sm-6 flex-column d-flex">
                                            ...
                                            <input type="text" id="username" name="username" value="{{ $utilisateur->username }}">
                                        </div>
                                        <div class="form-group col-sm-6 flex-column d-flex">
                                        ...
                                        <div class="form-group col-sm-6 flex-column d-flex">
                                            <label class="form-control-label px-3">Rôle</label> 
                                            <input type="text" id="role" name="role" value="{{ $utilisateur->role }}">
                                        </div>
                                    </div>
                                    <div class="row justify-content-between text-left">
                                        <div class="form-group col-sm-6 flex-column d-flex">
