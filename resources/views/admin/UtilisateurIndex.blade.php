        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gray-600" id="sidenav-main">
            ...
            <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white active" style="background-color:#e10505;" href="{{ route('Utilisateurs.index') }}">
                            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl" id="navbarBlur" data-scroll="true">
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        ...
                        <h6 class="font-weight-bolder mb-0">Liste des utilisateurs</h6>
                    </nav>
                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="shadow-primary border-radius-lg pt-4 pb-3" style="background-color:#e10505;">
                                    <h6 class="text-white text-capitalize ps-3">Tables des utilisateurs</h6>
                                </div>
                            </div>
                            <div class="card-body px-0 pb-2">
                                <div class="d-flex m-2 justify-content-start">
                                    <a class="btn btn-primary justify-content-center" style="background-color: #00811e; height: 40px; padding: 4px;  box-shadow: rgba(0, 129, 30, 0.16) 0px 10px 36px 0px, rgba(0, 129, 30, 0.06) 0px 0px 0px 1px;" href="{{ route('Utilisateurs.create') }}">
                                        <div class="row">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex justify-content-center">
                                                            <div class="mx-2">
                                                                <a class="btn btn-primary" style="background-color: #00889d; width: 40px; height: 40px; padding: 4px; box-shadow: rgba(0, 136, 157, 0.16) 0px 10px 36px 0px, rgba(0, 136, 157, 0.06) 0px 0px 0px 1px;" href="{{ route('Utilisateurs.show', $utilisateur->id) }}">
                                                            ...
                                                            <div class="mx-2">
                                                                <a class="btn btn-success" style="background-color: #ffc107; height: 40px; width: 40px; padding: 4px;  box-shadow: rgba(255, 193, 7, 0.16) 0px 10px 36px 0px, rgba(255, 193, 7, 0.06) 0px 0px 0px 1px;" href="{{ route('Utilisateurs.edit', $utilisateur->id) }}">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28" height="28" viewBox="0,0,256,256">
                                                                        <g fill="#ffffff" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal">
                                                                            <g transform="scale(4,4)">
