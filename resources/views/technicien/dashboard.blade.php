    ...
    <body class="g-sidenav-show  bg-gray-200">
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gray-600" id="sidenav-main">
            ...
            <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link text-white active"  style="background-color:#e10505;" href="{{ route('technicien.index') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white " href="{{ route('Reparation_panne.index') }}">
                            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <div class="container-fluid py-4">
                <div class="row">
                    <div class="col-lg-6 col-md-6 mb-4">
                        <a href="{{ route('Reparation_panne.index') }}" class="text-decoration-none">
                            <div class="card card-frame bg-white">
                                <div class="card-body d-flex align-items-center justify-content-center" style="padding: 2px;">
                                    ...
                                    <h6 class="mb-0" style="color: black; font-size: 24px; font-weight: 200; font-style: italic;">Liste des pannes</h6>
                                </div>
                            </div>
                        </a>
                    </div>
                ...
                <footer class="footer py-4" style="margin-top: 280px;">
