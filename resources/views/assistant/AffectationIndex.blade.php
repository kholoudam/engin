                                    ...
                                    <table class="table align-items-center mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Affectation</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach($demandes as $demande)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a href="{{ route('affectation.create',  $demande->id) }}" class="btn btn-primary">Confirmer</a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        </tbody>
                                            ...
                                            @foreach($affectations as $affectation)
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        @endphp
                                                        {{ $traitement ? $traitement->utilisateur->nom : 'Utilisateur non trouvé' }}
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="d-flex justify-content-center">
                                                            <div class="mx-2">
                                                                <a class="btn btn-primary" style="background-color: #00889d; width: 40px; height: 40px; padding: 4px; box-shadow: rgba(0, 136, 157, 0.16) 0px 10px 36px 0px, rgba(0, 136, 157, 0.06) 0px 0px 0px 1px;" href="{{ route('affectation.show', $affectation->id) }}">
