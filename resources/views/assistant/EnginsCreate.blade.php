                ...
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Ajouter un engin</li>
                        </ol>
                        <h6 class="font-weight-bolder mb-0">Ajouter un engin</h6>
                    </nav>
                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="shadow-primary border-radius-lg pt-4 pb-3" style="background-color:#e10505;">
                                    <h6 class="text-white text-capitalize ps-3">Ajouter un engin</h6>
                                </div>
                            </div>
                            <div class="card-body px-0 pb-2">
                                <form action="{{ route('engin.store') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="row justify-content-between text-left" style="margin-left: 100px; margin-right: 100px;">
                                        <div class="form-group col-sm-6 flex-column d-flex">
                                            ...
                                            <input type="number" id="Capacité" name="Capacité">
                                        </div>
                                        <div class="form-group col-sm-6 flex-column d-flex">
                                    ...
                                    <div class="row justify-content-between text-left">
                                        <div class="form-group col-sm-6 flex-column d-flex">
                                            <button type="submit" class="btn btn-primary btn-block mb-4 mt-3" style="background-color:#00811e; width: 120px; margin-left: 400px;">Ajouter</button>
                                        </div>
                                        <div class="form-group col-sm-6 flex-column d-flex">
