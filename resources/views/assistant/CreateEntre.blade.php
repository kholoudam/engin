        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gray-600" id="sidenav-main">
            ...
            <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white active"  style="background-color:#e10505;" href="{{ route('entre.index') }}">
                            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Confirmer l'affectation</li>
                        </ol>
                        <h6 class="font-weight-bolder mb-0">Confirmer l'affectation</h6>
                    </nav>
                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="shadow-primary border-radius-lg pt-4 pb-3" style="background-color:#e10505;">
                                    <h6 class="text-white text-capitalize ps-3">Confirmer l'affectation</h6>
                                </div>
                            </div>
                            <div class="card-body px-0 pb-2">
                                ...
                                @endif
                                <form action="{{ route('entre.store') }}" method="POST">
                                    @csrf
                                    <div>
                                        @foreach ($criteria as $criterion)
                                            <div class="form-group">
                                                <label>{{ $criterion->nom }}</label>
                                                <div>
                                                    <label>
                                                        <input type="radio" name="criteria[{{ $criterion->id }}]" value="Yes"> Oui
                                                    </label>
                                                    <label>
                                                        <input type="radio" name="criteria[{{ $criterion->id }}]" value="No"> Non
                                                    </label>
                                                </div>
                                            </div>
                                        @endforeach
                                    </div>
                                    <div id="enginForm" style="display:none;">
                                        <div class="form-group">
                                            <label for="engin_id">Nom de l'Engin</label>
                                            <select class="form-control" name="engin_id" required>
                                                <option value="" disabled selected>-- Sélectionnez un engin --</option>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="nom_conducteur" required>
                                        </div>
                                        <div class="form-group">
                                            <label for="prenom_conducteur">Prénom du Conducteur</label>
                                            <input type="text" class="form-control" name="prenom_conducteur" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label for="compteur_valeur">Compteur Valeur Actuelle</label>
                                            <input type="number" class="form-control" name="compteur_valeur" required>
                                        </div>
                                        <button type="submit" id="submitButton" class="btn btn-primary" disabled>Confirmer</button>
                                    </div>
                                </form>
                            </div>
                            <script>
                                document.addEventListener('DOMContentLoaded', function() {
                                    const yesButtons = document.querySelectorAll('input[type="radio"][value="Yes"]');
                                    const submitButton = document.querySelector('#submitButton');
                                    const enginForm = document.querySelector('#enginForm');
                                    const errorMessage = document.querySelector('#errorMessage');
                                    yesButtons.forEach(button => {
                                        button.addEventListener('change', checkCriteria);
                                    });
                                    function checkCriteria() {
                                        ...
                                        if (allYes) {
                                            ...
                                            enginForm.style.display = 'block';
                                            errorMessage.style.display = 'none';
                                        } else {
                                            submitButton.disabled = true;
                                            enginForm.style.display = 'none';
