                        ...
                        <div class="card my-4">
                            ...
                            <div class="card-body px-0 pb-2">
                                <div class="d-flex m-2 justify-content-start">
                                    <a class="btn btn-primary justify-content-center" style="background-color: #00811e; height: 40px; padding: 4px;  box-shadow: rgba(0, 129, 30, 0.16) 0px 10px 36px 0px, rgba(0, 129, 30, 0.06) 0px 0px 0px 1px;" href="{{ route('engin.create') }}">
                                        <div class="row">
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="d-flex justify-content-center">
                                                            <div class="mx-2">
                                                                <a class="btn btn-primary" style="background-color: #00889d; width: 40px; height: 40px; padding: 4px; box-shadow: rgba(0, 136, 157, 0.16) 0px 10px 36px 0px, rgba(0, 136, 157, 0.06) 0px 0px 0px 1px;" href="{{ route('engin.show', $engin->id) }}">
                                                            ...
                                                            <div class="mx-2">
                                                                <a class="btn btn-success" style="background-color: #ffc107; height: 40px; width: 40px; padding: 4px;  box-shadow: rgba(255, 193, 7, 0.16) 0px 10px 36px 0px, rgba(255, 193, 7, 0.06) 0px 0px 0px 1px;" href="{{ route('engin.edit', $engin->id) }}">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28" height="28" viewBox="0,0,256,256">
                                                                        <g fill="#ffffff" fill-rule="nonzero" stroke="none" stroke-width="1" stroke-linecap="butt" stroke-linejoin="miter" stroke-miterlimit="10" stroke-dasharray="" stroke-dashoffset="0" font-family="none" font-weight="none" font-size="none" text-anchor="none" style="mix-blend-mode: normal">
                                                                            <g transform="scale(4,4)">
                                                            ...
                                                            <div class="mx-2">
                                                                <form method="POST" action="{{ route('engin.destroy', $engin->id) }}">
                                                                    @csrf
                                                                    @method("delete")
