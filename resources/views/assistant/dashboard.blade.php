    ...
    <body class="g-sidenav-show  bg-gray-200">
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gray-600" id="sidenav-main">
            ...
            <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link text-white active"  style="background-color:#e10505;" href="{{ route('assistant.index') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white " href="{{ route('sortie.index') }}">
                            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <div class="card">
                            <div class="card-header p-3 pt-2">
                                ...
                                <div class="text-end pt-1">
                                    <p class="text-sm mb-0 text-capitalize">Total des engins</p>
                                    <h4 class="mb-0" id="sum-engins">Loading...</h4>
                                </div>
                            </div>
                            <hr class="dark horizontal my-0">
                            <div class="card-footer p-3">
                                <p class="mb-0">Nombre total des engins</p>
                            </div>
                        </div>
                        <script>
                    ...
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-header p-3 pt-2">
                                ...
                                <div class="text-end pt-1">
                                    <p class="text-sm mb-0 text-capitalize">Total des pannes</p>
                                    <h4 class="mb-0" id="sum-pannes">Loading...</h4>
                                </div>
                            </div>
                            <hr class="dark horizontal my-0">
                            <div class="card-footer p-3">
                                <p class="mb-0">Nombre total des pannes</p>
                            </div>
                        </div>
                        <script>
                            document.addEventListener('DOMContentLoaded', function () {
                                // Récupérer le total des pannes
                                fetch('/api/sum-pannes')
                                    .then(response => response.json())
                                    .then(data => {
                                        document.getElementById('sum-pannes').innerText = data.sum;
                                    });
                            });
                        </script>
                    </div>
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="card">
                            <div class="card-header p-3 pt-2">
                                ...
                                <div class="text-end pt-1">
                                    <p class="text-sm mb-0 text-capitalize">Total des affectations</p>
                                    <h4 class="mb-0" id="sum-affectations">Loading...</h4>
                                </div>
                            </div>
                            <hr class="dark horizontal my-0">
                            <div class="card-footer p-3">
                                <p class="mb-0">Nombre total des affectations</p>
                            </div>
                        </div>
                        <script>
                            document.addEventListener('DOMContentLoaded', function () {
                                // Récupérer le total des affectations
                                fetch('/api/sum-affectations')
                                    .then(response => response.json())
                                    .then(data => {
                                        document.getElementById('sum-affectations').innerText = data.sum;
                                    });
                            });
                        </script>
                    </div>
                        ...
                        <div class="col-lg-6 col-md-6 mb-4">
                            <div class="card">
                                <div class="card-header p-3 pt-2">
                                    ...
                                    <div class="text-end pt-1">
                                        <h6 class="mb-0">Affectations récentes</h6>
                                        ...
                                        <table class="table align-items-center mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($latestA as $A)
                                                    <tr>
                                                        <td class="text-center">{{ $A->DateAffectation ? \Carbon\Carbon::parse($A->DateAffectation)->format('d M Y') : 'Not Set' }}</td>
                                                        <td class="text-center">{{ $A->etat }}</td>
                                                        <td class="text-center">{{ $A->engin->Nom }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
                                        ...
                                        <table class="table align-items-center mb-0">
                                            ...
                                            <tbody>
                                                @foreach ($latestP as $P)
                                                    <tr>
                                                        <td class="text-center">{{ $A->engin ? $A->engin->Nom : 'Aucun engin associé' }}</td>
                                                        <td class="text-center">{{ $P->engin->Nom }}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                                        </table>
