                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="shadow-primary border-radius-lg pt-4 pb-3" style="background-color:#e10505;">
                                    <h6 class="text-white text-capitalize ps-3">Détail d'engins entrés</h6>
                                </div>
                            </div>
                                ...
                                <div class="container-fluid py-4">
                                    <div class="row-2">
                                        <a class="btn btn-danger" style="background-color:#e10505; width: 120px; height: 40px;" href="javascript:history.back();">
                                            <h6>
                                                <svg fill="#fff" height="30px" width="30px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 512 512" xml:space="preserve" stroke="#f"></svg>
                                                Retour
                                            </h6>
                                        </a>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card" style="width: 30rem; margin-left: 18rem; background-color: #d8d8d8;">
                                                <div class="card-body">
                                                    <h5 class="card-title text-center">{{ $EntreEngin->engin->Nom }}</h5>
                                                    <p class="card-text">
                                                        <strong>Description: </strong>{{ $EntreEngin->description }}<br>
                                                        <strong>Matricule: </strong>{{ $EntreEngin->matricule }}<br>
                                                        <strong>Societe: </strong>{{ $EntreEngin->societe }}<br>
                                                        <strong>Nom du conducteur: </strong>{{ $EntreEngin->nom_conducteur }}<br>
                                                        <strong>Prénom du conducteur: </strong>{{ $EntreEngin->prenom_conducteur }}<br>
                                                        <strong>Observation: </strong>{{ $EntreEngin->observation }}<br>
                                                        <strong>La valeur du compteur: </strong>{{ $EntreEngin->compteur_valeur }}<br>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
