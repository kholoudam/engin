        ...
        <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 bg-gray-600" id="sidenav-main">
            ...
            <div class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white active" style="background-color:#e10505;" href="{{ route('panne.index') }}">
                            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                                    ...
                                    <div class="row">
                                        @foreach($engins as $engin)
                                            <div class="col-sm-6 col-md-4 col-lg-3 mt-4">
                                                <div class="card h-100" style="background-color: #eeececa7;">
                                                    <img class="card-img-top" src="{{asset( $engin->Image )}}" alt="Image de {{ $engin->Nom }}">
                                                    <div class="card-block">
                                                        <h4 class="card-title text-center">{{ $engin->Nom }}</h4>
                                                        <div class="card-text">
                                                            <p class="text-bold text-uppercase">
                                                                Les pannes à réparer:
                                                            </p>
