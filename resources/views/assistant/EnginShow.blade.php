                ...
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Détail d'engins</li>
                        </ol>
                        <h6 class="font-weight-bolder mb-0">Détail d'engins</h6>
                    </nav>
                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="shadow-primary border-radius-lg pt-4 pb-3" style="background-color:#e10505;">
                                    <h6 class="text-white text-capitalize ps-3">Détail d'engins</h6>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card" style="width: 30rem; margin-left: 18rem; background-color: #d8d8d8;">
                                                <img src="{{asset( $engin->Image )}}" class="card-img-top" alt="Image de {{ $engin->Nom }}">
                                                <div class="card-body">
                                                    <h5 class="card-title text-center">{{ $engin->Nom }}</h5>
                                                    <p class="card-text">
                                                        <strong>id: </strong>{{ $engin->id }}
                                                        </br>
                                                        <strong>Capacité: </strong>{{ $engin->Capacité }}
                                                        </br>
                                                        <strong>Compteur: </strong>{{ $engin->Compteur }}
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
