                ...
                <div class="container-fluid py-1 px-3">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                            ...
                            <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Entrée engin</li>
                        </ol>
                        <h6 class="font-weight-bolder mb-0">Entrée engin</h6>
                    </nav>
                        ...
                        <div class="card my-4">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="shadow-primary border-radius-lg pt-4 pb-3" style="background-color:#e10505;">
                                    <h6 class="text-white text-capitalize ps-3">Table des Engins Entrés</h6>
                                </div>
                            </div>
                            <div class="card-body px-0 pb-2">
                                <div class="d-flex m-2 justify-content-start">
                                    <a class="btn btn-primary justify-content-center" style="background-color: #00811e; height: 40px; padding: 4px;  box-shadow: rgba(0, 129, 30, 0.16) 0px 10px 36px 0px, rgba(0, 129, 30, 0.06) 0px 0px 0px 1px;" href="{{ route('entre.create') }}">
                                        <div class="row">
                                    ...
                                    <table class="table align-items-center mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Société</th>
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Nom Conducteur</th>
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Prénom Conducteur</th>
                                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Action</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            @foreach($entre_engins as $entre_engin)
                                                <tr>
                                                    <td class="text-center">{{ $entre_engin->matricule }}</td>
                                                    <td class="text-center">{{ $entre_engin->societe }}</td>
                                                    <td class="text-center">{{ $entre_engin->nom_conducteur }}</td>
                                                    <td class="text-center">{{ $entre_engin->prenom_conducteur }}</td>
                                                    <td class="text-center">
                                                        <div class="d-flex justify-content-center">
                                                            <div class="mx-2">
                                                                <a class="btn btn-primary" style="background-color: #00889d; width: 40px; height: 40px; padding: 4px; box-shadow: rgba(0, 136, 157, 0.16) 0px 10px 36px 0px, rgba(0, 136, 157, 0.06) 0px 0px 0px 1px;" href="{{ route('entre.show', $entre_engin->id) }}">
