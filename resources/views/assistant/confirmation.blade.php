                    ...
                    <div class="col-12">
                        <div class="card my-4">
                            ...
                            <div class="card-body px-0 pb-2">
                                <div class="container-fluid py-4">
                                    <a class="btn btn-primary" style="background-color:#e10505; width: 120px; height: 40px; display: flex; align-items: center; justify-content: center; text-decoration: none; color: #ffffff;" href="javascript:history.back();">
                                        <svg fill="#ffffff" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="30px" height="30px" viewBox="0 0 70 70" enable-background="new 0 0 70 70" xml:space="preserve">
                                            <g>
                                                <g>
                                                ...
                                                <g>
                                                    <path d="M47.412,31.325c2.209,0,4,1.791,4,4s-1.791,4-4,4s-4-1.791-4-4S45.203,31.325,47.412,31.325 M47.412,27.325 c-4.411,0-8,3.589-8,8s3.589,8,8,8s8-3.589,8-8S51.823,27.325,47.412,27.325L47.412,27.325z"/>
                                                </g>
                                            </g>
                                        </svg>
                                        Retour
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body" style="width: 30rem; margin-left: 280px; background-color: #d8d8d8;">
                                                @if($affectation->engin)
                                                    <h5 class="card-title text-center">{{ $affectation->engin->Nom }}</h5>
                                                    <p class="card-text">
                                                        <strong>Date d'Affectation: </strong>{{ $affectation->DateAffectation }}<br>
                                                        <strong>État: </strong>{{ $affectation->etat }}<br>
                                                ...
                                                <form method="POST" action="{{ route('sortie.store') }}">
                                                    ...
                                                    <button type="submit" class="btn btn-primary" style="background-color: #00811e; font-style: oblique 30deg; font-size:18px; width: 260px; height: 50px; padding: 2px; margin-left: 80px; margin-bottom: -30px;  box-shadow: rgba(0, 129, 30, 0.16) 0px 10px 36px 0px, rgba(0, 129, 30, 0.06) 0px 0px 0px 1px;">
                                                        Confirmer la Sortie
                                                    </button>
                                                </form>
                                            </div>
